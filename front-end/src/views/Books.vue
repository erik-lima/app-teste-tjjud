...
const { list, destroy } = useBooksService();
...
async function removeItem(item) {
  if (window.confirm("Quer realmente remover esse livro?")) {
                ...
                <tbody>
                  <tr v-for="book in bookList" :key="book.cod">
                    ...
                    <td>
                      {{
                        book.assuntos
                          ? book.assuntos.map((e) => e.descricao).join(", ")
                          : "--"
                      }}
                    </td>
                    <td>{{ book.valor }}</td>
                    <td class="text-right">
                      <button
                        ...
                        @click="openDialogFormModal(book)"
                      >
